...
Ou seja, uma classe usa outras classes como atributos.

No exemplo abaixo, a classe GameStudio usa a classe Game como
atributo
'''
class Game:
...
# Adicionando jogos a instància de GameStudio
