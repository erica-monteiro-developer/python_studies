'''
O propósito desse módulo é gerar valores aleatórios, números, 
caracteres aleatórios, etc.
'''
import random
...
print(random.sample(list1, 2)) # [4, 2]
print(random.sample(list1, 3)) # [2, 3, 1]
s = "Olá mundo"
print(random.sample(s, 2))  # ['d', 'm']
